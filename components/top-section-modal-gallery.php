...
if(count($car_slug) == 3){
    ...
    $car_data = car_list($conn, [end($var_slug)],'Modal_Slug',['Variant'],'',false, 'Price'); 
    $car_single = car_list($conn, [end($car_slug)],'Variant_Slug',['Variant'],'',true, 'Price'); 

} else {
    $car_data = car_list($conn, [end($car_slug)],'Modal_Slug',['Variant'],'', false, 'Price'); 
}
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 pe-lg-0 pe-3 <?php if(empty($file_name)) {echo "align-content-center"; } ?>">
                <div class="yc-car-gallery">
                    ...
                    <?php else: ?>
                        <img src="<?php site_url(); ?>/assets/img/yaara-logo.png" class="img-fluid">
                    <?php endif; ?>
            ...
            <div class="col-lg-6 col-md-6 ps-lg-5 ps-md-5">
                <div class="yc-single-car-content">
                    ...
                    <div class="yc-single-car-desc mt-4">
                        ...
                        <h4 class="yc-price">
                            <?php if(count($car_slug) == 3): ?>
                                 <?php echo $car_data[0]['Currency'] ?> <span class="yc-start-price"><?php echo $car_single['Price']; ?></span>
                            <?php else: ?>
                                From <?php echo $car_data[0]['Currency'] ?> <span class="yc-start-price"><?php echo $first_item['Price']; ?></span> <span class="yc-end-price">- <?php echo $last_item['Price']; ?></span>
                            <?php endif; ?>
