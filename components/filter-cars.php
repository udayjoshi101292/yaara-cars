...
<div class="yc-filter-form common_box_shadow col-lg-4 col-md-4 col-12 p-4 " data-aos="fade-right"  data-aos-offset="300" data-aos-duration="1000">
                    ...
                    <form class="yc-form-main d-grid home-page-filter-form" action="search" method="POST">
                        
                        <div class="radio_button_holder">
                            <div class="radio_wrap input_radio_checked">
                                <span class="radio_input_warp">
                                    <input  type="radio" class="input_radio_budget car_filter_input" id="budget" name="filter-form" value="budget" checked>
                            ...
                            <div class="radio_wrap">
                                <span class="radio_input_warp">
                                    <input class="input_radio_label input_radio_brand car_filter_input" type="radio" id="model" name="filter-form" value="Model">
                                    <span class="custom_cheackmark"></span>
                                </span>
                        ...
                        <fieldset class="">
                            <div class="filter_select_wrap select_budget_wrap_in_view">
                                ...
                                <div class="form-Body-Type form-option select_wrap ">
                                <select name="brand-name"  class="selectbox  js-example-basic-single">

                                    <option value=""   selected>Select Brand</option>
                                    
                                    <?php $carsList = "SELECT * FROM yc_master ORDER BY Brand ASC";
