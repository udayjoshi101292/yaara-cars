    ...
    <div class="container advertise_wrapper templates_bg_border_padding_fff my-1">
                    ...
                    <div class="row ">
                        <div class="col-md-6">
                            <div class="adv_page_title_wrap">
                                <h1 class="adv_page_title">Rev Up Your<br>Business with Us!</h1>
                                ...
                                <div class="adv_page_title_button">
                                    <a href="#" class="common_button">Discover how</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="adv_page_banner_img_holder">
                                <img src="../assets/img/adv-page-banner-img.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center pt-3">
                        <div class="col-md-9">
                            <div class="adv_speedometer_img_wrap">
                                <img src="../assets/img/adv-page-banner-sub-img.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="owl-carousel owl-theme adv_owl_carousel">
                        <div class="item adv_single_brand_logo">
                            <img src="../assets/img/adv-brand-logo-01.png" alt="">
                        </div>
                        <div class="item adv_single_brand_logo">
                            <img src="../assets/img/adv-brand-logo-02.png" alt="">
                        </div>
                        <div class="item adv_single_brand_logo">
                            <img src="../assets/img/adv-brand-logo-03.png" alt="">
                        </div>
                        <div class="item adv_single_brand_logo">
                            <img src="../assets/img/adv-brand-logo-04.png" alt="">
                        </div>
                        <div class="item adv_single_brand_logo">
                            <img src="../assets/img/adv-brand-logo-05.png" alt="">
                        </div>
                        <div class="item adv_single_brand_logo">
                            <img src="../assets/img/adv-brand-logo-06.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row advertise_solutions_wrapper">
                <div class="col-md-12">
                    <div class="our_adv_solutions mt-3">
                        <h5 class="our_adv_short_contact_title my-2 text-center">Our Advertising Solutions</h5>
        ...
        <div class="row contact_form_section mt-2 mb-5">
            <div class="col-md-12 my-3">
                <h5 class="form_title">Grow Your Business with Us!</h5>
                ...
                <form action="<?php site_url();?>/form.php" method="POST" class="contact_form" id="contact_adv_form">
                    <div class="form_inner_wrapper">
                        ...
                        <div class="form_checkbox">
                            ...
                            <label for="terms_and_conditions">I agree to <a href="<?php echo main_url();?>/terms-conditions">Terms & Conditions</a></label>
                        </div>
