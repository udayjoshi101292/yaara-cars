        ...
        <div class="row" data-aos-duration="1500" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="col-12">
                ...
                <div class="yc-page-desc">
                    ...
                    <p>
                      In <?php echo $brand_price[0]['Location']; ?>, <?php echo $brand_price[0]['Brand']; ?> currently offers a total of <?php echo car_count($brand_price); ?> car models including <?php echo  car_count($hatchbacks); ?> Hatchbacks, <?php echo  car_count($Sedans); ?> Sedans, and <?php echo  car_count($SUVs); ?> SUVs. <?php echo $brand_price[0]['Brand']; ?>  manufacturer offers <?php echo car_count($petrol); ?> petrol variants, <?php echo  car_count($diesel); ?> diesel variants, <?php echo car_count($elec); ?> electric variants, and <?php echo car_count($cng); ?> CNG variants.
                    </p>
                        <?php echo $brand_price[0]['Content']; ?>

                        <p>The most affordable model is <?php echo $first_['Modal']; ?> with a price of <?php echo $brand_price[0]['Currency']; ?> <?php echo $first_['Price']; ?>  and the most expensive one being <?php echo $last_['Modal']; ?> priced at <?php  echo $brand_price[0]['Currency']; ?> <?php echo $last_['Price']; ?>.</p>

                        <p>Check <?php echo $brand_price[0]['Brand']; ?> car prices, latest offers, variants, specifications, pictures, mileage, and watch videos.</p>
                        <p><strong><?php echo date("F Y"); ?> <?php echo $brand_price[0]['Brand']; ?> Car Price List in <?php echo $brand_price[0]['Location']; ?></strong></p>

                        <?php /*
                        <b class="mb-3 d-block"><?php echo $brand_price[0]['Brand']; ?> Models <?php echo  $brand_price[0]['Currency']; ?> <?php echo  $first_['Price'].
                        " - ".$last_['Price']; ?>:</b>
                        */ ?>
                ...
                <div class="news_wrap common_box_shadow">
                    ...
                    <div class="news_desc">
                        ...
                        <div class="blog-content">
                            ...
                            <?php 
                                if($post['Excerpt']) {
                                    echo substr($post['Excerpt'],0,175).'...';
                                } else {
                                    echo substr($post['Content'],0,175).'...';
                                }
                            ?>       
