...
if(in_array(end($car_slug), $filter_uri) && count($car_slug) == 2){ //Refer Routes.php file for variable values
    ...
    $brand = ['Toyota', 'Hyundai', 'Bentley', 'Ford', 'Kia', 'Mercedes-Benz', 'Chevrolet', 'Nissan', 'Mitsubishi', 'BMW', 'Honda', 'Volvo'];
    ...
    $brand = ['Sportage', 'Bronco', 'Sonata', 'Yukon', 'ZS', 'Elantra'];
    ...
    $brand = ['208', '2008', 'ZS EV', 'Ioniq', 'E-HS9', 'Taycan'];
    $brand_data =  car_list($conn, $brand,'Modal', ['Modal','Brand'],'');
