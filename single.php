                        ...
                        <div class="col-lg-5 col-md-5 col-12">
                            ...
                            <h4 class="yc-h3-title three">
                                ...
                                if($first_car['Price'] != "TBD"){
                                 ...
                                 <?php 
                                //  $the_price;
                                //  if($first_car['Currency'] == 'SAR'){
                                //     $the_price = $first_car['Price'];
                                // }else{
                                //      $the_price = number_format($first_car['Price'],0);
                                //  }
                                 ?>
                ...
                <div class="yc-single-car-content news-bar p-3 mb-3">
                    ...
                    <div class="yc-trend-car-desc row mt-4">
                        <div class="col-12">
                            ...
                            <?php $post_list = get_post($conn, 'knowledge-hub',5); ?> 
