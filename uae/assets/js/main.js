...
let select_budget_data_keys = ['val_empty', '50000', '51000-100000', '101000-200000', '201000-300000', '301000-500000', '501000-700000']
let select_body_data_vals = ["Select Budget", "Upto AED 50K", "AED 51K - 100K", "AED 101K - 200K", "AED 201K - 300K", "AED 301K - 500K", "AED 501K - 700K"]
...
$(document.body).on("change", ".select_brand_wrap", function (e) {
    ...
    $.ajax({
        url: "https://uae.yaaracars.com/action.brandfilter.php",
        method: "POST",
        cache: false,
...
$(document.body).on(`submit`, `#filter-cars`, function (e) {
    ...
    if (By_budget === 'budget' && $(BudgetField).prop('checked') === true) {
        ...
        // console.log(ThisForm, BudgetField, By_budget,Budget,Brand);
...
function phone_num_validation(x) {
    ...
    // let result = /^(?:\+971|00971|0)(?:2|3|4|6|7|9|50|51|52|55|56)[0-9]{7}$/.test(inp_phone_num_val);
