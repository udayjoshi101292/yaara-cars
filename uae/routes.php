...
$all_routes = [
    "/uae" => 'front-page.php',
    '/uae/car-prices' => 'cars/car-filter.php',
    // '/make-price' => 'cars/make-price.php',
    // '/site' => 'sitemap/images-sitemap.php',
    // '/test' => 'test.php'
];
...
elseif(in_array(end($car_slug), $filter_uri) && count($car_slug) == 2){
    ...
    $meta_desc = "Get a list of $brandName $brandTransmission Cars in $brandloc. Find the latest prices, specs, features, mileage, images, and other details at YaaraCars.";
...
elseif(in_array(end($car_slug), $fuel_uri) && count($car_slug) == 2){
    ...
    $meta_desc = "Find the complete list of $brandName $brandFuel Cars in $brandloc. Get the latest prices, specs, features, mileage, images, and other details at YaaraCars.";
...
elseif(in_array(end($car_slug), $body_uri) && count($car_slug) == 2){
    ...
    $meta_desc = "View list of $brandName $brandBodyType Cars in $brandloc. Also, get the latest prices, specs, features, mileage, images, and other details at YaaraCars.";
