...
<head>
    ...
    <title> <?php //echo page_title($conn, $car_slug)  
    ...
    <div style="display: none;">
        <?php require_once dirname(__DIR__) .'/uae/schema.php';
        ?>
    </div>
</head>
                    ...
                    <div class="col-lg-auto col-md-auto col-auto ms-auto d-lg-grid d-md-grid d-none align-content-center">
                        <div class="yc-top-items">
                            <ul class="yc-top-items-list">
                                ...
                                <!-- <li class="yc-top-list-items">
                                    <img src="<?php //site_url(); 
                                                ?>/assets/img/account_circle.svg" alt="" class="img-fuild">
                                    Account
                                    <span class="yc-icon"><img src="<?php //site_url(); 
                                                                    ?>/assets/img/down-arrow.svg" alt="" class="img-fuild"></span>
                                </li> -->
                                ...
                                <ul class="yc-nav-list">
                                        ...
                                        <ul class="yc-sub-menu">
                                            ...
                                            <li id="sub-menu-item" class="sub-menu-item">
                                                ...
                                                <ul class="yc-sub-menu sub-level-2">
                                                    ...
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/forthing/prices">Forthing Prices</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/skywell/prices">Skywell Prices</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/tank/prices">Tank Prices</a></li>
                                                    ...
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/honda/prices">Honda Prices</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li id="sub-menu-item" class="sub-menu-item">
                                                ...
                                                <ul class="yc-sub-menu sub-level-2">
                                                    ...
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/forthing">Forthing</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/skywell">Skywell</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/tank">Tank</a></li>
                                                    ...
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/mercedes-benz">Mercedes-Benz</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/hyundai">Hyundai</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/honda">Honda</a></li>
                                                </ul>
                                            ...
                                            <li id="sub-menu-item" class="sub-menu-item">
                                                ...
                                                <span class="yc-icon"><img src="<?php site_url(); ?>/assets/img/down-arrow.svg" alt="" class="img-fuild"></span>
                                                <ul class="yc-sub-menu sub-level-2">
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/toyota/raize">Toyota Raize</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/toyota/rush">Toyota Rush</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/nissan/xterra">Nissan Xterra</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/nissan/x-trail">Nissan X-Trail</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/nissan/kicks">Nissan Kicks</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/nissan/patrol">Nissan Patrol</a></li>
                                                </ul>
                                            </li>
                                            <li id="sub-menu-item" class="sub-menu-item">
                                                ...
                                                <span class="yc-icon"><img src="<?php site_url(); ?>/assets/img/down-arrow.svg" alt="" class="img-fuild"></span>
                                                <ul class="yc-sub-menu sub-level-2">
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/audi/e-tron-sportback">Audi e-tron Sportback</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/tesla/model-3">Tesla Model 3 2024</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/polestar/2">Polestar 2 2024</a></li>
                                                    <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/tesla/model-x">Tesla Model X 2024</a></li>
                                    ...
                                    <li class="yc-nav-items yc-nav-has-children">
                                        ...
                                        <ul class="yc-sub-menu">
                                            ...
                                            <?php $carMenu = ['Toyota', 'Nissan', 'Hyundai', 'Mercedes-Benz', 'Kia', 'Mitsubishi', 'BMW', 'Chevrolet', 'Ford', 'Honda']; ?>
                                    ...
                                    <li class="yc-nav-items yc-nav-has-children">
                                        ...
                                        <span class="yc-icon"><img src="<?php site_url(); ?>/assets/img/down-arrow.svg" alt="" class="img-fuild"></span>
                                        <ul class="yc-sub-menu">
                                            <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/50000">Upto <?php echo $car_list[0]['Currency']; ?> 50K</a></li>
                                            <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/51000-100000"><?php echo $car_list[0]['Currency']; ?> 51K - 100K</a></li>
                                            <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/101000-200000"><?php echo $car_list[0]['Currency']; ?> 101K - 200K</a></li>
                                            <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/201000-300000"><?php echo $car_list[0]['Currency']; ?> 201K - 300K</a></li>
                                            <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/301000-500000"><?php echo $car_list[0]['Currency']; ?> 301K - 500K</a></li>
                                            <li id="sub-menu-item" class="sub-menu-item"><a href="<?php site_url(); ?>/501000-700000"><?php echo $car_list[0]['Currency']; ?> 501K - 700K</a></li>
                                        </ul>
                                    </li>
                                    <li class="yc-nav-items yc-nav-has-children">
