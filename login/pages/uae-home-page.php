<?php // Template Name: UAE Home


$single_page_title = "UAE Home Page";
include "../common.php";
...
$cars_data = brand_modal($conn, 'UAE');

// echo "<pre>";
// print_r($cars_data);
// echo "</pre>";
$uae_ksa_home_data = uae_ksa_home($conn, 'UAE Home', true);
// echo "<pre>";
// print_r($uae_ksa_home_data['section_banner']);
// echo "</pre>";

// foreach($uae_ksa_home_data['section_banner'] as $el){
//     echo "<pre>";
//     print_r($el);
//     echo "</pre>";
// }
...
$file_p = $_SERVER['DOCUMENT_ROOT'] . '/assets/img/dummy-img/';
// echo "<pre>";
// print_r(scandir($file_p));
// echo "</pre>";
...
// echo $site_url_backend.'/assets/img/dummy-img/';
// print_r($uae_ksa_home_data['section_banner'][1]['image']);
