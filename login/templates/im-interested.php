...
$im_interested_data = im_interested_leads($conn);
// echo "<pre>";    
// print_r($im_interested_data);
// echo "</pre>";    
...
<div class="row ">
    <div class="col-md-12 ">
        <h2 class="section_titles">Enquiry Form Leads</h2>
    </div>
</div>
    ...
    <table id="table_main_id" class="display leads_table_tag">
            <thead>
                <tr>
                    ...
                    <th class="table_head_text">Model</th>
                    <!-- <th class="table_head_text">Variant</th> -->
                    <!-- <th class="table_head_text">Message</th> -->
                    <th class="table_head_text">Page URL</th>
                    <th class="table_head_text">Utm Source</th>
                    <th class="table_head_text">Utm Medium</th>
                    <th class="table_head_text">Utm Campaign</th>
                    <th class="table_head_text">Utm Term</th>
            ...
            <tbody>
                ...
                $region_col;
                // print_r($lead_data);
                foreach ($im_interested_data as $yc_leads):
                ...
                ?>
                    <tr>
                        ...
                        <td class="table_data_text"><?php echo $yc_leads["Brand"] ?></td>
                        <td class="table_data_text"><?php echo $yc_leads["Modal"] ?></td>
                        <!-- <td class="table_data_text"><?php //echo $yc_leads["Variant"] ?></td> -->
                        <td class="table_data_text"><a href="<?php echo $yc_leads["Page_Url"] ?>" target="_blank"><?php echo $yc_leads["Page_Url"] ?></a></td>
                        
                        <td class="table_data_text"><?php echo empty($yc_leads["utm_source"]) ? '-' : $yc_leads["utm_source"] ;?></td>
                        <td class="table_data_text"><?php echo empty($yc_leads["utm_medium"]) ? '-' : $yc_leads["utm_medium"] ;?></td>
                        <td class="table_data_text"><?php echo empty($yc_leads["utm_campaign"]) ? '-' : $yc_leads["utm_campaign"] ;?></td>
                        <td class="table_data_text"><?php echo empty($yc_leads["utm_term"]) ? '-' : $yc_leads["utm_term"] ;?></td>
