...
$column_name = car_data($conn, $default = array('table_name' => 'yc_measurement'));
$data = get_data_data_testing($conn, 'yc_measurement', 'ID', null, $page, null, null, $filter_emp_arr);

// $get_filter_01 = get_data_data_testing($conn, 'yc_measurement', null, null, null, ' GROUP BY Location  ', ' Location ');

$count_data = get_data_data_testing($conn, 'yc_measurement', 'ID', true, null, null, null, $filter_emp_arr) / 10;
...
<section class="py-4">
    <div class="row">
        <div class="col-md-12 ">
            <h2 class="section_titles">All Measurement</h2>
        </div>
    </div>
    ...
    <form action="" method="GET" class="d-none">
        <div class="filter_wrap ">
            <?php // echo  select_filters($get_filter_01,'Location', 'Location', array('name' => 'location')) ?>
    ...
    <form action="../export-import.php" method="post" class="mt-2" enctype="multipart/form-data">
        ...
        <input type="hidden" value="yc_measurement-ID" name="table-name">
    </form>
