...
$column_name = car_data($conn, $default = array('table_name' => 'yc_safety'));
$data = get_data_data_testing($conn, 'yc_safety', 'ID', null, $page, null, null, $filter_emp_arr);

$get_filter_01 = get_data_data_testing($conn, 'yc_safety', null, null, null, ' GROUP BY Camera_360  ', ' Camera_360 ');

$count_data = get_data_data_testing($conn, 'yc_safety', 'ID', true, null, null, null, $filter_emp_arr) / 10;
...
<section class="py-4">
    <div class="row">
        <div class="col-md-12 ">
            <h2 class="section_titles">All Safety</h2>
        </div>
    </div>
    ...
    <form action="" method="GET">
        <div class="filter_wrap ">
            <?php echo  select_filters($get_filter_01,'Camera 360', 'Camera_360', array('name' => 'Camera_360')) ?>
    ...
    <form action="../export-import.php" method="post" class="mt-2" enctype="multipart/form-data">
        ...
        <input type="hidden" value="yc_safety-ID" name="table-name">
    </form>
