...
$column_name = car_data($conn, $default = array('table_name' => 'yc_exterior'));
$data = get_data_data_testing($conn, 'yc_exterior', 'ID', null, $page, null, null, $filter_emp_arr);

$get_filter_01 = get_data_data_testing($conn, 'yc_exterior', null, null, null, ' GROUP BY Acoustic_Hood  ', ' Acoustic_Hood ');

$count_data = get_data_data_testing($conn, 'yc_exterior', 'ID', true, null, null, null, $filter_emp_arr) / 10;
...
<section class="py-4">
    <div class="row">
        <div class="col-md-12 ">
            <h2 class="section_titles">All Exterior</h2>
        </div>
    </div>
    ...
    <form action="" method="GET">
        <div class="filter_wrap ">
            <?php echo  select_filters($get_filter_01,'Acoustic Hood', 'Acoustic_Hood', array('name' => 'Acoustic_Hood')) ?>
    ...
    <form action="../export-import.php" method="post" class="mt-2" enctype="multipart/form-data">
        ...
        <input type="hidden" value="yc_exterior-ID" name="table-name">
    </form>
