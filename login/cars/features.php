...
$column_name = car_data($conn, $default = array('table_name' => 'yc_features'));
$data = get_data_data_testing($conn, 'yc_features', 'ID', null, $page, null, null, $filter_emp_arr);

$get_filter_01 = get_data_data_testing($conn, 'yc_features', null, null, null, ' GROUP BY 12V_Socket  ', ' 12V_Socket ');
$get_filter_02 = get_data_data_testing($conn, 'yc_features', null, null, null, ' GROUP BY Active_Steering  ', ' Active_Steering ');

$count_data = get_data_data_testing($conn, 'yc_features', 'ID', true, null, null, null, $filter_emp_arr) / 10;
...
<section class="py-4">
    <div class="row">
        <div class="col-md-12 ">
            <h2 class="section_titles">All Features</h2>
        </div>
    </div>
    ...
    <form action="" method="GET">
        <div class="filter_wrap ">
            <?php echo  select_filters($get_filter_01,'12V Socket', '12V_Socket', array('name' => '12V_Socket')) ?>
            <?php echo  select_filters($get_filter_02,'Active Steering', 'Active_Steering', array('name' => 'Active_Steering')) ?>
    ...
    <form action="../export-import.php" method="post" class="mt-2" enctype="multipart/form-data">
        ...
        <input type="hidden" value="yc_features-ID" name="table-name">
    </form>
