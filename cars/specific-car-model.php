...
$car_modal_slug = $car_slug; array_pop($car_modal_slug);

$car_all = car_list($conn, [end($car_modal_slug)],'Modal_Slug',['Variant']); 

$car_data = car_list($conn, [end($car_slug)],'Variant_Slug',['Variant'],'',true); 
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-12">
                ...
                <?php foreach(car_list($conn, [$car_data['Brand']], 'Brand',['Brand', 'Modal']) as $car): 
                    
                    $gallery = car_thumbnail($car);

                    if($car['Price'] != "DISCONTINUED" && $car['Price'] != "" && end($car_slug) != $car['Variant_Slug']):
                    ...
                    <div class="item car-item common_box_shadow">
                        ...
                        <div class="yc-cars-details">
                            ...
                            <h4>
                                <?php echo $car['Currency'].' '.$car['Price']; ?>
                            </h4>
