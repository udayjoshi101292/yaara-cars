...
<section class="yc-car-brand-page pt-5">
    <div class="container">
        <div class="row" data-aos-duration="1500" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="col-12">
                <h2 class="titles_h2">
                <?php echo $brand_price[0]['Brand']; ?> Car Models
                </h2>
                <div class="yc-page-desc">
                    ...
                    <div class="page_desc_text">
                        ...
                        <p>Check out the details of all <?php echo $brand_price[0]['Brand']; ?> cars in <?php echo $brand_price[0]['Location']; ?> along with the price range for <?php echo date("F Y"); ?>:</p>

                        <b class="mb-3 d-block"><?php echo $brand_price[0]['Brand']; ?> Models <?php echo  $brand_price[0]['Currency']; ?> <?php echo  $first_['Price']." - ".$last_['Price']; ?>:</b>
                            <ul class="price-range-list">
                                <?php foreach($brand_price as $price): ?>
                                <li class="mb-3">
                                    <a href="<?php echo site_url()."/".$price['Brand_Slug']."/".$price['Modal_Slug'];?>">
                                        <?php echo $price['Brand']." ".$price['Modal']." ".$price['Currency']." <b>".$price['Price']."</b>";?>
                                    </a>
                                </li>
                                <?php endforeach; ?>
                            </ul>
